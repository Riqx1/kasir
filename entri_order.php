          ...
          <div class="widget-content nopadding">
            <table class="table table-bordered table-invoice-full">
              ...
              <tbody>
                <?php
                  $no_order_fiks = 1;
                  $query_order_fiks = "select * from tb_pesanan natural join tb_menu where id_user = $id and status_pesan != 'sudah'";
    ...
    <div class="row-fluid">
              ...
              <div class="btn-icon-pg">
                <ul>
                  ...
                  <?php
                    ...
                    $query_lihat_pesan = "select * from tb_pesanan where id_user = $id and status_pesan != 'sudah'";
                  ...
                  ?>
                    ...
                    <?php
                      ...
                      if(isset($_REQUEST['tambah_pesan'])){
                        ...
                        $query_tambah_pesan = "insert into tb_pesanan values('', '$id', '', '$id_masakan', '', '')";
                        $sql_tambah_pesan= mysqli_query($conn, $query_tambah_pesan);

                        $query_lihat_pesannya = "select * from tb_pesanan order by id_pesan desc limit 1";
                        ...
                        $query_olah_stok = "insert into tb_transaksi values('', '$id_pesannya', '', 'belum cetak')";
        ...
        <div class="widget-box">
          ...
          <div class="widget-content nopadding">
            <table class="table table-bordered table-striped">
              ...
              <tbody>
              <?php
                $query_draft_pesan = "select * from tb_pesanan natural join tb_menu where id_user = $id and status_pesan != 'sudah'";
      ...
      <?php
          ...
          if(isset($_POST['hapus_pesan'])){
            ...
            $query_hapus_pesan = "delete from tb_pesanan where id_pesan = $id_pesan";
          ...
          if(isset($_POST['proses_pesan'])){
            ...
            $query_ubah_jumlah = "select * from tb_pesanan left join tb_menu on tb_pesanan.id_masakan = tb_menu.id_masakan where id_user = $id and status_pesan != 'sudah'";
            ...
            while($r_ubah_jumlah = mysqli_fetch_array($sql_ubah_jumlah)){
              ...
              //echo $tempe;
              $query_proses_ubah = "update tb_pesanan set jumlah = $tempe, id_order = $id_ordernya where id_masakan = $tahu and id_user = $id and status_pesan != 'sudah'";
              $query_kurangi_stok = "update tb_menu set stok = $sisa_stok where id_masakan = $tahu";
              
              $query_kelola_stok = "update tb_transaksi set jumlah_terjual = $tempe where id_pesan = $id_pesan";
