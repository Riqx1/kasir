                          ...
                          <tr>
                            ...
                            <td>
                              <center>
                                ...
                                $query_jumlah = "select sum(jumlah_terjual) as jumlah_terjual from tb_transaksi left join tb_pesanan on tb_transaksi.id_pesan = tb_pesanan.id_pesan where id_masakan = $id_masakan and status_cetak = 'belum cetak'";
        ...
        <div class="container-fluid">
          <div class="row-fluid">
            <ul class="quick-actions">
              ...
              <li class="bg_ly">
                <a target='_blank' href="cetak_laporan.php?konten=<?php echo $r_sudah_order['id_order']; ?>" class="btn btn-mini btn-success">
