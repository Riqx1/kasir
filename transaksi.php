    ...
    ?>
          ...
          <div class="widget-content nopadding" >
            <table class="table table-bordered table-invoice-full">
              ...
              <tbody>
                <?php
                  $no_order_fiks = 1;
                  $query_order_fiks = "select * from tb_pesanan left join tb_menu on tb_pesanan.id_masakan = tb_menu.id_masakan where id_user = $id_pemesan and status_pesan != 'sudah'";
      ...
      <?php
          ...
          if(isset($_REQUEST['save_order'])){
            ...
            $query_selesai_pesan = "update tb_pesanan set status_pesan = 'sudah' where id_user = $id_pemesan and status_pesan != 'sudah'";
